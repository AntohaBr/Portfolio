...
export const SvgIconCss = (props:any) => (
    <svg
        width={30}
        height={30}
    ...
    >
        ...
        <path
            d="M405.5 467.454 269.29 504.13l-136.212-36.676-31.432-340.525h335.29L405.5 467.454z"
            fill="#2062af"
        />
        <path
        ...
        <path
            d="m269.168 239.656-97.49 40.602 3.233 40.199 94.257-40.301 100.265-42.868 4.157-41.122-104.422 43.49z"
            fill="#fff"
        />
        <linearGradient
            id="a"
        ...
        <path
            d="m171.677 280.258 3.233 40.199 94.257-40.301v-40.5l-97.49 40.602z"
            fill="url(#a)"
        />
        <linearGradient
            id="b"
        ...
        <path
            d="m373.59 196.167-104.422 43.489v40.5l100.265-42.868 4.157-41.121z"
            fill="url(#b)"
        />
        <linearGradient
            id="c"
        ...
        <path
            d="m171.827 280.258 3.234 40.199 144.625.461-3.235 53.598-47.59 13.398-45.748-11.551-2.772-33.268h-42.508l5.545 64.225 85.945 25.412 85.479-24.951 11.09-127.523H171.827z"
            fill="url(#c)"
        />
        <path
            d="M269.168 280.258h-97.49l3.233 40.199 94.257.301v-40.5zm0 107.528-.462.129-45.742-11.551-2.772-33.268h-42.507l5.544 64.225 85.939 25.412v-44.947z"
            opacity={0.05}
        />
        <linearGradient
            id="d"
